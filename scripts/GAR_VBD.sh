...
# 共通パラメータ（配列で定義）
# common_params=(--supervised --dataset "volleyball" --data_path "/home-local/tezuka/" --backbone_learnable --num_frame 10 --num_total_frame 10 --num_activities 6 --lr 5e-6 --max_lr 5e-5 --weight_decay 5e-5)
# common_params=(--supervised --dataset "volleyball" --data_path "/home-local/tezuka/" --backbone_learnable --num_frame 1 --num_total_frame 10 --num_activities 8 --lr 5e-6 --max_lr 5e-5 --weight_decay 5e-5)
# common_params=(--supervised --dataset "volleyball" --data_path "/home-local/tezuka/" --backbone_learnable --backbone_learnable_layers 2 --num_frame 10 --num_total_frame 10 --num_activities 6 --lr 2e-6 --max_lr 2e-5 --weight_decay 2e-5)
# common_params=(--supervised --dataset "volleyball" --data_path "/home-local/tezuka/" --backbone_learnable --backbone_learnable_layers 2 --num_frame 10 --num_total_frame 10 --num_activities 6 --lr 5e-6 --max_lr 5e-5 --weight_decay 5e-5)
# common_params=(--supervised --dataset "volleyball" --data_path "/home-local/tezuka/" --backbone_learnable --num_frame 10 --num_total_frame 10 --num_activities 8 --lr 1e-7 --max_lr 1e-6 --weight_decay 2e-5)
#common_params=(--dataset "volleyball" --data_path "/home-local/tezuka/" --dino_learnable --num_frame 10 --num_total_frame 10 --num_activities 8 --lr 1e-6 --max_lr 1e-5 --weight_decay 1e-5)

# cos scheduler
# common_params=(--supervised --dataset "volleyball" --data_path "/home-local/tezuka/" --num_frame 10 --num_total_frame 10 --num_activities 8 --lr 2e-5)
# common_params=(--supervised --dataset "volleyball" --data_path "/home-local/tezuka/" --backbone_learnable --backbone_learnable_layers 2 --num_frame 10 --num_total_frame 10 --num_activities 6 --lr 1e-5)
common_params=(--supervised --dataset "volleyball" --data_path "/home-local/tezuka/" --backbone_learnable --backbone_learnable_layers 2 --num_frame 10 --num_total_frame 10 --num_activities 6 --lr 5e-5)
...
# flow_lossをpeople lamaで学習した重み
# finetune_params=(--pretrained_weights '/home/tezuka/foundation/dinov2_with_attention_extraction/retrieval_result/[volleyball]_dino_flow_ball_numpy<2025-06-04_14-05-39>/epoch18_76.74.pth')
# 504x896でflow, ball lossで学習した重み
# finetune_params=(--pretrained_weights '/home/tezuka/foundation/dinov2_with_attention_extraction/retrieval_result/[volleyball]_dino_flow_ball_numpy<2025-07-25_15-30-08>/epoch24_81.97.pth')
# 504x896でpre flow loss, fine ball lossで学習した重み w/o people, w/o ball lama
# finetune_params=(--pretrained_weights '/home/tezuka/foundation/dinov2_with_attention_extraction/finetune_result/[volleyball]_dino_flow_ball_finetune<2025-08-06_19-18-40>/epoch16_80.85.pth')
# 504x896でpre flow loss, fine ball lossで学習した重み w/o people, w/ ball lama
# finetune_params=(--pretrained_weights '/home/tezuka/foundation/dinov2_with_attention_extraction/finetune_result/[volleyball]_dino_flow_ball_finetune<2025-08-09_14-17-38>/epoch28_83.47.pth')

# DINOv3 288x512でpre flow loss, fine ball lossで学習した重み  w/ ball lama detector
# finetune_params=(--pretrained_weights '/home/tezuka/foundation/dinov2_with_attention_extraction/finetune_result/[volleyball]_dino_flow_ball_finetune<2025-09-03_00-58-10>/epoch20_81.23.pth')
# DINOv3 576x1024でpre flow loss, fine ball lossで学習した重み  w/ ball lama detector
# finetune_params=(--pretrained_weights '/home/tezuka/foundation/dinov2_with_attention_extraction/finetune_result/[volleyball]_dino_flow_ball_finetune<2025-09-12_18-13-59>/epoch26_84.97.pth')
# DINOv3 288x512でpre flow loss, fine ball lossで学習した重み  w/ ball lama detector
finetune_params=(--pretrained_weights '/home/tezuka/foundation/dinov2_with_attention_extraction/finetune_result/[volleyball]_dino_flow_ball_finetune<2025-09-03_00-58-10>/epoch20_81.23.pth')
...
# epochのオプション
# epochs=(--epochs 30)
# epochs=(--epochs 50 --lr_step 5 --lr_step_down 45)
...
# mask_params=(--ball_lama --frame_random --inpaint_prob 0.5 --people_lama --people_mask_scale 1.2 --inpaint_people_prob 0.1)
