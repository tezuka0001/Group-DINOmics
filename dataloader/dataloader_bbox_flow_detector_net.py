from .volleyball_bbox_flow_detector_net import *
from .nba_bbox_flow_detector_net import *
...
def read_dataset(args):
    ...
    if args.dataset == 'volleyball':
        ...
        net_path = data_path + "/volleyball_net_detection_all_frames"
        ...
        train_set = VolleyballDataset(train_frames, all_tracks, train_data, image_path, args, is_training=True, ball_annotation_path=bbox_path, tracking_path=tracking_path, net_annotation_path=net_path)
        train_set_for_val = VolleyballDataset(train_frames, all_tracks, train_data, image_path, args, is_training=False, ball_annotation_path=bbox_path, tracking_path=tracking_path, net_annotation_path=net_path)
        test_set = VolleyballDataset(test_frames, all_tracks, test_data, image_path, args, is_training=False, ball_annotation_path=bbox_path, tracking_path=tracking_path, net_annotation_path=net_path)
        ...
        net_path = data_path + "/nba/objects"
        ...
        train_set = NBADataset(train_frames, train_data, image_path, args, is_training=True, bbox_path=bbox_path, tracking_path=track_path, net_path=net_path)
        train_set_for_val = NBADataset(train_frames, train_data, image_path, args, is_training=False, bbox_path=bbox_path, tracking_path=track_path, net_path=net_path)
        test_set = NBADataset(test_frames, test_data, image_path, args, is_training=False, bbox_path=bbox_path, tracking_path=track_path, net_path=net_path)
    else:
        assert False
